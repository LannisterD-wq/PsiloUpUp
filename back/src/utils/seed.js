...
async function seedProducts() {
  ...
  if (count > 0) {
    await Product.update({ priceCents: 19990, imageUrl: '/images/sem fundo mind.png' }, { where: { sku: 'UP-MIND' } });
    await Product.update({ priceCents: 17990, imageUrl: '/images/sem fundo burn.png' }, { where: { sku: 'UP-BURN' } });
    await Product.update({ priceCents: 33990, imageUrl: '/images/burn.mind sem fundo.png' }, { where: { sku: 'STACK-DUPLO' } });
    return;
  }
