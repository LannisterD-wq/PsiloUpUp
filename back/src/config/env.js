...
const config = {
  ...
  shipping: {
    originCep: env('ORIGIN_CEP', '01310100'),
    defaultPackage: {
      height: Number(env('DEFAULT_PACKAGE_HEIGHT_CM', 10)),
      width: Number(env('DEFAULT_PACKAGE_WIDTH_CM', 15)),
      length: Number(env('DEFAULT_PACKAGE_LENGTH_CM', 20)),
      weight: Number(env('DEFAULT_PACKAGE_WEIGHT_KG', 0.5)),
    },
